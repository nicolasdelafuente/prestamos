...
<?php
if (isset($_SESSION['rechazarSolicitud']) && $_SESSION['rechazarSolicitud'] == 'complete'): ?>
	<div class="col-lg-6 mt-3">
		<div class="alert alert-info" role="alert">
			<i class="far fa-smile fa-2x mx-2"></i> La solicitud se ha rechazado. 
		</div>
	</div>
<?php elseif(isset($_SESSION['rechazarSolicitud']) && $_SESSION['rechazarSolicitud'] == 'failed'): ?>
	<div class="col-lg-6 mt-3">
		<div class="alert alert-danger" role="alert">
			<i class="far fa-angry fa-2x mx-2"></i> <strong> Error</strong>, intenta nuevamente. 
		</div>
...
<?php endif;?>
<?php Utils::deleteSession('rechazarSolicitud');?>
